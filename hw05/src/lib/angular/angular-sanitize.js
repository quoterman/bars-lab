     ...
     <script>
       function Ctrl($scope, $sce) {
         ...
         $scope.deliberatelyTrustDangerousSnippet = function() {
           return $sce.trustAsHtml($scope.prise);
         };
       }
     </script>
     <div ng-controller="Ctrl">
        Snippet: <textarea ng-model="prise" cols="60" rows="3"></textarea>
       <table>
         <tr>
           <td>Directive</td>
           <td>How</td>
         ...
         <tr id="bind-html-with-sanitize">
           ...
           <td><pre>&lt;div ng-bind-html="prise"&gt;<br/>&lt;/div&gt;</pre></td>
           <td><div ng-bind-html="prise"></div></td>
         </tr>
...
&lt;/div&gt;</pre>
         ...
         <tr id="bind-default">
           ...
           <td><pre>&lt;div ng-bind="prise"&gt;<br/>&lt;/div&gt;</pre></td>
           <td><div ng-bind="prise"></div></td>
         </tr>
       </table>
       </div>
   </file>
     ...
     <file name="index.html">
       ...
       <table>
         ...
         <tr id="linky-filter">
           <td>linky filter</td>
           <td>
             <pre>&lt;div ng-bind-html="prise | linky"&gt;<br>&lt;/div&gt;</pre>
           </td>
           <td>
             <div ng-bind-html="prise | linky"></div>
           </td>
         </tr>
         <tr id="linky-target">
          <td>linky target</td>
