...
angular.module('pagesData', [])
  ...
  "api/ng/type/$rootScope.Scope": {
    ...
    "searchTerms": {
      ...
      "keywords": "$injector $new $rootscope api append auto automatically child compiled created current default defaults docs1 example executed expect factory function handy hello html inherit inheritance instancecache interact js js-angular-release key map method module newly ng override parent partials pre-instantiated provided providers retrieved root rootscope salutation scope scopes service services simple prise src tag template toequal type unit-testing var world"
    }
  },
